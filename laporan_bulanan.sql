...
CREATE TABLE `perina` (
  ...
  `Nama_Tindakan` enum('IUFD','Rujuk','BBLR','Ranap_Anak','Ranap_Perina') NOT NULL,
...
--
ALTER TABLE `bangsal`
  MODIFY `ID_LB` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12322;

--
-- AUTO_INCREMENT for table `perina`
--
ALTER TABLE `perina`
  MODIFY `ID_LP` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=23239;

--
-- AUTO_INCREMENT for table `vk`
--
ALTER TABLE `vk`
  MODIFY `ID_VK` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7791;
COMMIT;
